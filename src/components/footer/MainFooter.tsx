  ...
  return (
    <footer className='bg-white border-t border-gray-200 text-gray-400 text-xs py-4 text-center fixed bottom-0 w-full'>
      <div className="flex items-center justify-around">
        ...
        <button className="p-3"><Search className="w-6 h-6 text-gray-400" /></button>
        <button className="p-3"><Mic className="w-6 h-6 text-gray-400" /></button>
        <button className="p-3"><MessageSquare className="w-6 h-6 text-gray-400" /></button>
