...
export default function MacInstallModal({ open, onClose }: Props) {
    useEffect(() => {
        if (open) {
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="text-xl xs:text-2xl font-bold mb-4">MacOS 앱 설치 안내</h2>
                ...
                <ol className=" w-max list-decimal list-inside text-left text-xs xs:text-sm text-gray-700 space-y-2 mb-5 mx-auto">
                    <li>메뉴 막대에서 <strong>파일(File)</strong>을 선택합니다.</li>
                    <li><strong>Dock에 추가(Add to Dock)</strong>를 선택합니다.</li>
                    <li>LINKLE 앱 추가를 선택합니다.</li>
                </ol>
